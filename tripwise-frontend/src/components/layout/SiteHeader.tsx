...
const NAV_ITEMS = [
  ...
  { id: "identify", label: "Start Journey", sub: "Identify your vibe" },
  { id: "plan", label: "Plan Trip", sub: "Craft your itinerary" },
  { id: "guide", label: "Local Guide", sub: "Explore like a local" },
];
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-[100] flex justify-center p-6 transition-all duration-500">
      ...
      >
        ...
        >
          <img src={logoMark} alt="TripWise" className="h-8 w-8 object-contain" />
          <span className={cn(
        ...
        <div
          className={`fixed inset-0 z-[150] flex flex-col transition-all duration-700 ease-&lsqb;cubic-bezier(0.85,0,0.15,1)&rsqb; ${
