      ...
      >
        <div className="text-center mb-10">
          ...
          >
            ...
            <span className="text-xs font-medium tracking-wider text-gray">STEP {step} OF 2</span>
          </motion.div>
          ...
          >
            {step === 1 ? (
              <>What's Your <span className="text-gradient-pastel">Name</span>?</>
            ) : (
              <>How Can We <span className="text-gradient-pastel">Reach You</span>?</>
            )}
          </motion.h2>
          <motion.p
            initial={{ opacity: 0 }}
          ...
          >
            {step === 1 ? 'Tell us your name to get started' : 'Enter your phone or email'}
          </motion.p>
        </div>
          ...
          <form onSubmit={handleContactSubmit} className="space-y-7">
            ...
            {isReturning === false && identifier && (
              ...
              >
                ...
                <span className="font-semibold">Let's plan your first adventure, {name}!</span>
              </motion.div>
            )}
